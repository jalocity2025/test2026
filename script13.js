const fullQuestionBank = [
    ...
    { "q": "يعد الحضور الشخصي مع أنظمة الحكومة الإلكترونية هو الوسيلة الوحيدة لإنجاز الأعمال والحصول على الخدمات الحكومية.", "options": ["صح", "خطأ"], "answer": 1 },
    ...
    { "q": "النافذة التي تعطيك فكرة عن مكان ظهور النموذج على الشاشة بعد تنفيذ التطبيق هي نافذة:", "options": ["المشروع", "شكل النموذج", "النموذج", "مستكشف المشروع"], "answer": 1 },
...
"\"نعم\"=Command1.Text "],
 "answer": 1 },
    ...
    { "q": "أي مما يلي لا يعد من أعراض الإصابة بالفيروسات:", "options": ["تغير حجم أيقوات الملفات", "توقف النظام بدون سبب", "تغير شاشة التوقف بشكل متكرر", "البطء المفاجئ في أداء الحاسوب"], "answer": 2 },
    ...
    { "q": "تُعد التعاملات بين الحكومة والمصارف الأهلية من تفاعلات الحكومة الإلكترونية التي تتم بين:", "options": ["المواطن إلى الحكومة", "القطاع الخاص إلى الحكومة", "الحكومة إلى الحكومة", "الحكومة إلى المواطن"], "answer": 1 },
    ...
    { "q": "تتم إضافة البرامج الفرعية والدوال في بيئة البيسك المرئي من شريط القوائم خلال قائمة:", "options": ["المشروع Project", "الأدوات Tools", "ملف File", "الإضافات Add Ins"], "answer": 1 }
];
