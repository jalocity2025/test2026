const fullQuestionBank = [
    ...
    { "q": "فتح أي ملف مرفق ضمن رسالة بريد إلكتروني لا يُعرف مصدرها من طرق الوقاية من الفيروسات.", "options": ["صح", "خطأ"], "answer": 1 },
    { "q": "يتم استدعاء الأحداث بكتابة الاسم البرمجي للأداة ثم النقطة ثم اسم الحدث.", "options": ["صح", "خطأ"], "answer": 1 },
  ...
  { "q": "وظيفة المقطع \n<div class='code-block'>For i=0 To 2\nFor j=0 To 2\na(i,j)=InputBox(\"\")\n Next j\n Next i</div>","options": ["طباعة عناصر قطر المصفوفة", "إدخال عناصر المصفوفة", "طباعة عناصر المصفوفة", "قراءة عناصر قطر المصفوفة"], "answer": 1 },
    ...
    { "q": "تعد الدالة الجاهزة (Val) من الدوال:", "options": ["الرياضية", "التاريخ والوقت", "الحرفية", "التحويلية"], "answer": 2 },
    ...
    { "q": "في مراحل تطور الحكومة الإلكترونية، يبدأ التفاعل المباشر بين المواطن والإدارة الحكومية المفردة للخدمة في مرحلة:", "options": ["تكامل الخدمات", "النشر الإلكتروني", "التفاعل وتبادل البيانات", "الظهور الحكومي"], "answer": 2 }
];
