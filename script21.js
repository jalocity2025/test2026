...
const fullQuestionBank = [
  {
    "q": "اذا كانت  \"s = \"visual    ما الامر الذي يقوم بطباعة الثلاث احرف في المنتصف",
    "options": [
      "Print Mid(s, 3, 3)",
      "Print Len(s)",
      "Print Left(s, 3)",
...
{
    "q": "اذا كانت  \"s = \"visual    ما الامر الذي يقوم طول الجملة",     "options": [
      "Print Len(s)",
      "Print Mid(s, 3, 3)",
      "Print Left(s, 3)",
      "Print Right(s, 3)"
 ...
 {
    "q": "ما ناتج تنفيذ الامر  print abs (45.5)  ",
    "options": [
      "45.5",
      "45",
      "46",
...
{ "q": "يمكننا من شريط القوائم MenuBar إضافة نموذج جديد Add Form للمشروع من خلال القائمة Edit.", "options": ["صح", "خطأ"], "answer": 1 },
 ...
 {
    "q": "   ما ناتج الامر  Print Len(\"visual basic\") ",
    "options": [
      "12",
      "5",
      "11",
 ...
 {
    "q": "ما القيمة المعادة من الجمله A=Mid(\"Free Libya\",6,5)",
    "options": [
      "Libya",
      "bya",
      "fre ",
...
{ "q": "الدالة التي ترجع الجزء الصحيح فقط من الرقم هي:", "options": ["Trim", "Int", "Chr", "Val"], "answer": 1 },
 ...
 {
    "q": "اذا كان تاريخ اليوم هو 13/6/2021 والساعة الان 11:46:20pm\nما ناتج الامر   print Format(Date, MM,DD,YYYY)",
    "options": [
      "06/13/2021",
      "13/6/2021 11:46:20 pm",
      "11:46:20 pm",
      "13/06/2021"
    ],
    "answer": 0
 ...
 {
    "q": " Print Len(\"visual basic\") + abs(-5)  ما ناتج الامر   ",
    "options": [
      "17",
      "12",
      "11",
 ...
 {
    "q": "  ناتج الامر هو  Print Sqr(16) + int(4.5)     ",
    "options": [
      "20",
      "16",
      "4.5",
 ...
 {
    "q": "اذا كانت  \" s = \"AlWAHAT     ما الامر الذي يقوم بطباعة الاحرف الثلاث الأولى من بداية الجملة \n",
    "options": [
      "Print Left(s, 3)",
      "Print Right(s, 3)",
      "Print Mid(s, 3, 3)",
  ...
  {
    "q": "\nاذا كان تاريخ اليوم هو 13/6/2021 والساعة الان  11:46:20 pm\nما ناتج الامر    print Time",
    "options": [
      "11:46:20 pm",
      "13/6/2021",
      "13/6/2021 11:46:20 pm"
 ...
 {
    "q": "اذا كان تاريخ اليوم هو 13/6/2021 والساعة الان  11:46:20 pm\nما ناتج الامر  print Now",
    "options": [
      "13/6/2021 11:46:20 pm",
      "11:46:20 pm",
      "13/6/2021"
  ...
  {
    "q": "اذا كان تاريخ اليوم هو 13/6/2021 والساعة الان  11:46:20 pm\nما ناتج الامر    print Datevalue(Now)",
    "options": [
      "13/6/2021",
      "13/6/2021 11:46:20 pm",
      "11:46:20 pm"
 ...
 {
    "q": "ما القيمة المعادة من الجمله  A=Right(\"Free Libya\",5)",
    "options": [
      "Libya",
      "bya",
      "fre",
  ...
  },
{
  ...
  {
    "q": "  لا يمكن إنهاء تنفيذ الدالة إلا عند الوصول إلى جملة End Function.",
    "options": ["صح", "خطأ"],
    "answer": 1
  },
  {
    ...
    },
{
 ...
 {
    "q": "عدد معاملات الدالة\n<div class='code-block'>private function area(r as integer) as string\narea=3.14 * r * r\nend funstion</div>",
    "options": [
      "1",
      "2",
      "لا يوجد"
...
{
    "q": "اذا كان تاريخ اليوم هو السبت  13/6/2021  ما ناتج الامر\n<div class='code-block'>Private Sub Form_Load() \nPrint Weekday(#6/13/2021#) \nEnd Sub</div>",
    "options": [
      "7",
      "1",
      "4",
  ...
  {
    "q": "ما ناتج البرنامج\n<div class='code-block'>Private Sub cmd Print Click()\nDim x as Integer\nX = GetMin (12,5)\nPrint x\nEnd Sub\nFunction GetMin(a, b As Integer) As Integer\nIf a > b Then\nGetMin = a\nElse\nGetMin = b\nEnd If\nEnd Function</div>",
    "options": [
      "12",
      "5",
      "17",
